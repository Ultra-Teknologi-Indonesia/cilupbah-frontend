...
import { useExportPutawayPerformance } from "@/hooks/laporan/use-laporan-gudang";
import type { OrderPerformanceMode } from "@/types/laporan/laporan-gudang";

interface PutawayPerformanceDialogProps {
  open: boolean;
...
export function PutawayPerformanceDialog({
  open,
  onOpenChange,
}: PutawayPerformanceDialogProps) {
  ...
  const exportXlsx = useExportPutawayPerformance();
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          <DialogTitle>Performa Proses Penempatan</DialogTitle>
          <DialogDescription>
            Performa putaway per petugas berikut rata-rata durasi penempatan.
          </DialogDescription>
        </DialogHeader>
